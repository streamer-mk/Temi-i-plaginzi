...
if( ! $nav_show ): ?>
<header id="masthead" class="site-header header--s2 header--s9" data-height="<?php echo penci_get_data_height_nav(); ?>" <?php penci_get_schema_header(); ?>>
...
<?php endif; if ( ! ( $nav_show && $nav_remove_header ) ): ?>
